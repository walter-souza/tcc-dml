...
class Network(torch.nn.Module):
    def __init__(self, opt):
        ...
        # print("model.last_linear.in_features:", self.model.last_linear.in_features)
        # print("model.last_linear shape:")
        print(self.model.last_linear)
    
        self.layer_blocks = nn.ModuleList([self.model.layer1, self.model.layer2, self.model.layer3, self.model.layer4])

        # print("LAYER_BLOCK")
        # print(self.layer_blocks)
