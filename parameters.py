...
def basic_training_parameters(parser):
    ...
    parser.add_argument('--token_max_length',    default=64, type=int, help='Tokenizer max length.')
...
def wandb_parameters(parser):
    ...
    parser.add_argument('--wandb_key',       default='c8edf46023c425ec5cad286b148f93c85b0b37df',  type=str,   help='API key for W&B.')
    ...
    parser.add_argument('--online_backend',  default='wandb',                type=str,   help='What online backend is used.')                                                                                               
    return parser
